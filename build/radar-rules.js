({ "81.cn":{ _name:"中国军网",
  ...
  "12371.cn":{ _name:"共产党员网",
    www:[ { title:"最新发布",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:category" ],
        target:"/12371/:category?" } ] },
  "005.tv":{ _name:"幻之羁绊动漫网",
    ".":[ { title:"资讯",
      ...
      { title:"展会资讯",
        ...
        source:[ "/zh/" ],
        target:"/005/005/zh" } ] },
  "0xxx.ws":{ _name:"0xxx.ws",
    ".":[ { title:"Source",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/" ],
        target:"/0xxx(_,url)=>{const urlObj=new URL(url);const params=urlObj.searchParams;params.delete(\"next\");const filter=urlObj.searchParams.toString();return`/0xxx${filter?`/${filter}`:\"\"}`}" } ] },
  "10000link.com":{ _name:"10000万联网",
    info:[ { title:"新闻",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category" ],
  ...
  "4chan.org":{ _name:"4chan",
    boards:[ { title:"Board's catalog",
        docs:"https://docs.rsshub.app/routes/bbs",
        source:[ "/:board/" ],
  ...
  "8kcosplay.com":{ _name:"8KCosplay",
    ".":[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/picture",
        source:[ "/category/:mainCategory/:cat/",
          "/category/:cat/" ],
  ...
  "acgvinyl.com":{ _name:"ACG Vinyl - 黑胶",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/anime",
        source:[ "/" ],
  ...
  "aotter.net":{ _name:"电獭少女",
    agirls:[ { title:"当前精选主题列表",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/",
          "/topic" ],
  ...
  "github.io":{ _name:"AG⓪RA",
    agorahub:[ { title:"共和報",
        ...
        source:[ "/pen0" ],
        target:"/agora0/pen0" } ],
    mrinalxdev:[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/mrinalxblogs/blogs/blog.html",
          "/mrinalxblogs/" ],
  ...
  "pages.dev":{ _name:"AI 博客",
    "aiblog-2xv":[ { title:"归档-全部文章",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/archives" ],
        target:"/aiblog-2xv/archives" } ] },
  "ainvest.com":{ _name:"AInvest",
    www:[ { title:"Latest Article",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/news/articles-latest/",
          "/" ],
  ...
  "altotrain.ca":{ _name:"Alto - Toronto-Québec City High-Speed Rail Network",
    ".":[ { title:"Alto News",
        docs:"https://docs.rsshub.app/routes/travel",
        source:[ "/:language",
          "/:language/news",
  ...
  "alwayscontrol.com.cn":{ _name:"Always Control",
    www:[ { title:"最新动态",
        docs:"https://docs.rsshub.app/routes/other",
  ...
  "apple.com":{ _name:"Apple",
    ...
    podcasts:[ { title:"播客",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/:region/podcast/:showName/:id",
          "/:region/podcast/:id" ],
        target:"/apple/podcast/:id/:region?" } ] },
  "apple.com.cn":{ _name:"Apple",
    www:[ { title:"Newsroom (中国大陆)",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/newsroom",
          "/newsroom/:year/:month/:slug" ],
        target:"/apple/newsroom" } ] },
  ...
  "aschmelyun.com":{ _name:"Andrew Schmelyun",
    ".":[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/" ],
        target:"/aschmelyun/blog" } ] },
  "asiafruitchina.net":{ _name:"亚洲水果",
    ".":[ { title:"果蔬品项",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/categories" ],
  ...
  "atptour.com":{ _name:"ATP Tour",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/sport",
        source:[ "/" ],
  ...
  "bangumi.tv":{ _name:"Bangumi 番组计划",
    ".":[ { title:"Bangumi 用户收藏列表",
      ...
      { title:"用户日志",
        ...
        source:[ "/user/:id" ],
        target:"/bangumi.tv/user/blog/:id" } ] },
  "banshujiang.cn":{ _name:"搬书匠",
    ".":[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/reading",
        source:[ "/:category" ],
        target:"/banshujiangparams=>{const category=params.category;return`/banshujiang${category?`/${category}`:\"\"}`}" },
      { title:"ActionScript",
        docs:"https://docs.rsshub.app/routes/reading",
  ...
  "bbc.com":{ _name:"BBC",
    www:[ { title:"Sport",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/sport/:sport" ],
        target:"/bbc/sport/:sport" },
      { title:"Topics - BBC News 中文",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/zhongwen/topics/:topic/:variant" ],
        target:"/bbc/zhongwen/topics/:topic/:variant?" },
      { title:"Topics",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/news/topics/:topic" ],
        target:"/bbc/topics/:topic" } ] },
  "bbcnewslabs.co.uk":{ _name:"BBC News Labs",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/" ],
        target:"/bbcnewslabs/news" } ] },
  "bc3ts.net":{ _name:"爆料公社",
    web:[ { title:"動態",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/" ],
        target:"/bc3ts/post/list/:sort?" } ] },
  "beijingprice.cn":{ _name:"北京价格",
    ".":[ { title:"资讯",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:category" ],
  ...
  "biodiscover.com":{ _name:"biodiscover.com 生物探索",
    www:[ { title:"Unknown",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/:channel" ],
    ...
    ".":[ { title:"Recent Earthquakes",
      ...
      { title:"News",
        ...
        source:[ "/",
          "/berita" ],
        target:"/bmkg/news" } ] },
  "bnext.com.tw":{ _name:"數位時代 BusinessNext",
    www:[ { title:"最新文章",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/" ],
        target:"/bnext/bnext" } ] },
  ...
  "boc.cn":{ _name:"中国银行",
    ".":[ { title:"外汇牌价",
        ...
        source:[ "/sourcedb/whpj",
          "/" ],
        target:"/boc/whpj" } ] },
  "bookwalker.com.tw":{ _name:"BOOKWALKER電子書",
    www:[ { title:"搜尋",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search" ],
  ...
  "btbtt20.com":{ _name:"BT 之家",
    ".":[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/" ],
        target:"/btzj/:category?" } ] },
  "buct.edu.cn":{ _name:"北京化工大学",
    cist:[ { title:"信息学院",
        docs:"https://docs.rsshub.app/routes/university",
  ...
  "bupt.edu.cn":{ _name:"北京邮电大学",
    ...
    ".":[ { title:"人才招聘",
        ...
        source:[ "/" ],
        target:"/bupt/rczp" } ],
    scss:[ { title:"网络空间安全学院 - 通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/index/tzgg1.htm" ],
        target:"/bupt/scss/tzgg" } ] },
  "bvisness.me":{ _name:"Ben Visness",
    ".":[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/" ],
        target:"/bvisness/blog" } ] },
  "byau.edu.cn":{ _name:"黑龙江八一农垦大学",
    xinwen:[ { title:"新闻网",
        docs:"https://docs.rsshub.app/routes/university",
  ...
  "caicai.me":{ _name:"CaiCai",
    www:[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/blogs" ],
        target:"/caicai/blog/:lang?" },
      { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/zh/blogs" ],
        target:"/caicai/blog/zh" } ] },
  ...
  "canada.ca":{ _name:"Canada.ca",
    www:[ { title:"News by Department",
      ...
      { title:"News by Department",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:lang/innovation-science-economic-development/news/*",
  ...
  "carousell.com":{ _name:"Carousell",
    au:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
        target:"/carousell/au/:keyword" } ],
    ca:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
        target:"/carousell/ca/:keyword" } ],
    id:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
        target:"/carousell/id/:keyword" } ],
    nz:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
        target:"/carousell/nz/:keyword" } ],
    tw:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
        target:"/carousell/tw/:keyword" } ] },
  "carousell.com.hk":{ _name:"Carousell",
    www:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
        target:"/carousell/hk/:keyword" } ] },
  "carousell.com.my":{ _name:"Carousell",
    www:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
        target:"/carousell/my/:keyword" } ] },
  "carousell.ph":{ _name:"Carousell",
    www:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
        target:"/carousell/ph/:keyword" } ] },
  "carousell.sg":{ _name:"Carousell",
    www:[ { title:"Keyword Search",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/:keyword" ],
  ...
  "castanet.net":{ _name:"Castanet",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/news/:category/" ],
        target:"/castanet/:category" },
      { title:"News",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/" ],
        target:"/castanet/" } ] },
  "castbox.fm":{ _name:"Castbox",
    ".":[ { title:"Channels",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/channel/:channel" ],
        target:"/castbox/channel/:channel" } ] },
  "catticenter.com":{ _name:"全国翻译专业资格水平考试 (CATTI)",
    www:[ { title:"CATTI 考试消息",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/:category" ],
        target:"/catti/news/:category" } ] },
  "cau.edu.cn":{ _name:"中国农业大学",
    ciee:[ { title:"研招网通知公告",
        docs:"https://docs.rsshub.app/routes/university",
  ...
  "cbndata.com":{ _name:"CBNData",
    www:[ { title:"看点",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/information" ],
        target:"/cbndata(params,url)=>{const urlObj=new URL(url);const id=urlObj.searchParams.get(\"tag_id\")??void 0;return`/information${id?`/${id}`:\"\"}`}" },
      { title:"全部",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/information" ],
  ...
  "cccfna.org.cn":{ _name:"中国食品土畜进出口商会",
    www:[ { title:"资讯信息",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:category/:type" ],
        target:"/cccfna/:category/:type?" } ] },
  "cccmc.org.cn":{ _name:"中国五矿化工进出口商会",
    www:[ { title:"通用",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category" ],
  ...
  "china.com":{ _name:"China.com 中华网",
    finance:[ { title:"Finance News 财经 - 财经新闻",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category" ],
        target:"/china/finance/:category?" } ],
    news:[ { title:"News and current affairs 时事新闻",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category" ],
        target:"/china/news/:category?" } ],
    military:[ { title:"Military - Military News 军事 - 军事新闻",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/news" ],
        target:"/china/news/military" } ] },
  "chinacdc.cn":{ _name:"中国疾病预防控制中心",
    www:[ { title:"通用",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:category" ],
  ...
  "chinanews.com.cn":{ _name:"中国新闻网",
    ".":[ { title:"Unknown",
        ...
        source:[ "/" ],
        target:"/chinanews/" } ] },
  "chinania.org.cn":{ _name:"中国有色金属工业网",
    www:[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/new-media",
  ...
  "chinaratings.com.cn":{ _name:"中债资信评估有限责任公司",
    www:[ { title:"中债研究",
        docs:"https://docs.rsshub.app/routes/finance",
  ...
  "chlinlearn.top":{ _name:"chlinlearn 的技术博客",
    "daily-blog":[ { title:"值得一读技术博客",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/blogs/*" ],
  ...
  "chongbuluo.com":{ _name:"虫部落",
    www:[ { title:"最新发表",
        docs:"https://docs.rsshub.app/routes/bbs",
        source:[ "/" ],
        target:"/chongbuluo/newthread" } ] },
  "chongdiantou.com":{ _name:"充电头网",
    www:[ { title:"最新资讯",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/" ],
        target:"/chongdiantou/" } ] },
  ...
  "chuapp.com":{ _name:"触乐",
    ".":[ { title:"分类",
      ...
      { title:"分类",
        ...
        target:"/chuapp/night" } ] },
  "cib.com.cn":{ _name:"中国兴业银行",
    ".":[ { title:"外汇牌价",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/" ],
        target:"/cib/whpj" } ] },
  "cih-index.com":{ _name:"中指研究院",
    www:[ { title:"报告",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/report/list/:report" ],
        target:"/cih-index/report/list/:report?" } ] },
  "cisia.org":{ _name:"中国无机盐工业协会",
    www:[ { title:"栏目",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/site/term/:id" ],
  ...
  "claude.com":{ _name:"Claude",
    ".":[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/blog" ],
        target:"/claude/blog" } ],
    code:[ { title:"Code Changelog",
        docs:"https://docs.rsshub.app/routes/program-update",
        source:[ "/docs/en/changelog" ],
        target:"/claude/code/changelog" } ] },
  "cloudflarestatus.com":{ _name:"Cloudflare Status",
    www:[ { title:"Status",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/" ],
  ...
  "cnljxh.org.cn":{ _name:"中国炼焦行业协会",
    www:[ { title:"栏目",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category" ],
        target:"/cnljxh(params,url)=>{const urlObj=new URL(url);const category=params.category;const id=urlObj.searchParams.get(\"classid\")??void 0;return`/cnljxh${category?`/${category}${id?`/${id}`:\"\"}`:\"\"}`}" },
      { title:"协会专区 - 协会简介",
        docs:"https://docs.rsshub.app/routes/new-media",
  ...
  "cnu.edu.cn":{ _name:"首都师范大学",
    iec:[ { title:"信息工程学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
    ...
    jwc:[ { title:"教务处通知公示",
        ...
        target:"/cnu/cnu/jwc" } ],
    physics:[ { title:"物理系院系新闻",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/news/index.htm" ],
        target:"/cnu/cnu/physics" } ],
    smkxxy:[ { title:"生命科学学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
  ...
  "colamanga.com":{ _name:"COLAMANGA",
    www:[ { title:"Manga",
        ...
        source:[ "/:id/" ],
        target:"/colamanga/:id" } ] },
  "comic-fuz.com":{ _name:"COMIC FUZ",
    ".":[ { title:"杂志详情",
        docs:"https://docs.rsshub.app/routes/anime",
        source:[ "/magazine/:id" ],
        target:"/comic-fuz/magazine/:id" },
      { title:"漫画详情",
        docs:"https://docs.rsshub.app/routes/anime",
        source:[ "/manga/:id" ],
  ...
  "cool18.com":{ _name:"禁忌书屋",
    ".":[ { title:"禁忌书屋",
        docs:"https://docs.rsshub.app/routes/bbs",
        source:[ "/:id/" ],
        target:"/cool18/:id/:type?/:keyword?" } ] },
  "coolbuy.com":{ _name:"玩物志",
    ".":[ { title:"产品",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/" ],
        target:"/coolbuy/" } ] },
  "coolpc.com.tw":{ _name:"原價屋",
    www:[ { title:"促銷&開箱",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/" ],
        target:"/coolpc/news" } ] },
  "coomer.st":{ _name:"Coomer",
    ".":[ { title:"Posts",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/" ],
  ...
  "costar.com":{ _name:"CoStar",
    www:[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/" ],
        target:"/costar(_,url)=>{const filter=new URL(url).search?.replace(/\\?/,\"\");return`/costar/press-releases${filter?`/${filter}`:\"\"}`}" } ] },
  ...
  "cpta.com.cn":{ _name:"中国人事考试网",
    www:[ { title:"中国人事考试网通知公告",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/notice.html",
          "/" ],
        target:"/cpta/notice" },
    ...
    www:[ { title:"通告公示",
      ...
      { title:"学科学术",
        ...
        source:[ "/xkxs.htm",
          "/" ],
        target:"/csust/xkxs" } ] },
  "ctbu.edu.cn":{ _name:"重庆工商大学",
    www:[ { title:"学校公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/",
          "/index/xxgg.htm" ],
        target:"/ctbu/xxgg" } ] },
  "ctinews.com":{ _name:"中天新聞網",
    ".":[ { title:"話題",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/news/topics/:topic",
          "/" ],
  ...
  "cursor.com":{ _name:"Cursor",
    ".":[ { title:"Blog",
      ...
      { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/:locale/blog" ],
        target:"/cursor/blog/all/:locale" },
      { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/:locale/blog/topic/:topic" ],
        target:"/cursor/blog/:topic/:locale" },
      { title:"Changelog",
        docs:"https://docs.rsshub.app/routes/program-update",
        source:[ "/changelog" ],
      ...
      { title:"Changelog",
        ...
        target:"/cursor/changelog/:locale" } ] },
  ...
  "dbaplus.cn":{ _name:"dbaplus社群",
    ".":[ { title:"资讯",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/news*" ],
        target:"/dbaplus(_,url)=>{const urlObj=new URL(url);const href=urlObj.href;const id=href.match(/-(\\d+)-\\.html/)?.[1];return`/dbaplus/news${id?`/${id}`:\"\"}`}" },
      { title:"全部",
        docs:"https://docs.rsshub.app/routes/programming",
  ...
  "dewu.com":{ _name:"得物",
    tech:[ { title:"技术博客",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/" ],
        target:"/dewu/techblog" } ] },
  "dgtle.com":{ _name:"数字尾巴",
    www:[ { title:"文章",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/article" ],
  ...
  "digitalpolicyalert.org":{ _name:"Digital Policy Alert",
    ".":[ { title:"Activity Tracker",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/" ],
        target:"/digitalpolicyalert(_,url)=>{const urlObj=new URL(url);const filters=createSearchParams(urlObj.searchParams.toString()).toString();return`/digitalpolicyalert/activity-tracker${filters?`/${filters}`:\"\"}`}" } ] },
  "dingshao.cn":{ _name:"盯梢",
    www:[ { title:"频道",
        docs:"https://docs.rsshub.app/routes/other",
  ...
  "dpm.org.cn":{ _name:"The Palace Museum",
    www:[ { title:"Current Exhibitions",
        docs:"https://docs.rsshub.app/routes/travel",
        source:[ "/classify/exhibition.html" ],
        target:"/dpm/exhibitions" } ] },
  ...
  "easynomad.cn":{ _name:"轻松游牧-远程工作聚集地",
    ".":[ { title:"远程工作列表",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/" ],
        target:"/easynomad/" } ] },
  "ebc.net.tw":{ _name:"東森新聞",
    news:[ { title:"即時新聞",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/realtime/:category" ],
        target:"/ebc/:category" } ] },
  "ecnu.edu.cn":{ _name:"East China Normal University 华东师范大学",
    art:[ { title:"美术学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/art" } ],
    bksy:[ { title:"本科生院通知",
        ...
        source:[ "/" ],
        target:"/ecnu/bksy" } ],
    cee:[ { title:"通信与电子工程学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/cee" } ],
    chem:[ { title:"化学与分子工程学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/chem" } ],
    chinese:[ { title:"国际汉语文化学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/chinese" } ],
    comm:[ { title:"传播学院通知公告",
    ...
    cs:[ { title:"计算机科学与技术学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/cs" } ],
    cxcy:[ { title:"本科创新创业教育网",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/cxcy" } ],
    dase:[ { title:"数据科学与工程学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/dase" } ],
    dx:[ { title:"大夏书院通知公告",
    ...
    ed:[ { title:"教育学部通知公告",
        ...
        source:[ "/" ],
        target:"/ecnu/ed" } ],
    geoai:[ { title:"空间人工智能学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/geoai" } ],
    "www.ghcollege":[ { title:"光华书院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/ghcollege" } ],
    history:[ { title:"历史学系通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/history" } ],
    "www.jiaoliu":[ { title:"本科生交流通知",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/jiaoliu" } ],
    "www.jwc":[ { title:"教务处通知",
    ...
    www:[ { title:"教务处通知",
        ...
        source:[ "/" ],
        target:"/ecnu/tzgg" } ],
    mks:[ { title:"马克思主义学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/mks" } ],
    mxcsy:[ { title:"孟宪承书院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/mxcsy" } ],
    pharm:[ { title:"药学院通知公告",
        ...
        source:[ "/" ],
        target:"/ecnu/pharm" } ],
    "www.philo":[ { title:"哲学系通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/philo" } ],
    phy:[ { title:"物理与电子科学学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/phy" } ],
    psy:[ { title:"心理与认知科学学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/psy" } ],
    sees:[ { title:"生态与环境科学学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/sees" } ],
    sei:[ { title:"软件工程学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/sei" } ],
    spm:[ { title:"公共管理学院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/ecnu/spm" } ],
    stat:[ { title:"统计学院通知公告",
  ...
  "ecust.edu.cn":{ _name:"华东理工大学",
    e:[ { title:"继续教育学院 - 学院公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/engine2/m/38F638B77773ADD3",
          "/" ],
        target:"/ecust/jxjy/news" } ],
    gschool:[ { title:"研究生院通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/12753/list.htm",
          "/" ],
        target:"/ecust/yjs" } ] },
  "eeo.com.cn":{ _name:"经济观察网",
    www:[ { title:"快讯",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/kuaixun/" ],
        target:"/eeo/kuaixun" } ] },
  "egsea.com":{ _name:"e 公司",
    ".":[ { title:"快讯",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/news/flash" ],
        target:"/egsea/flash" } ] },
  ...
  "elamigos.site":{ _name:"ElAmigos",
    ".":[ { title:"Releases",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/",
          "/index.html" ],
        target:"/elamigos/games" } ] },
  ...
  "engineering.fyi":{ _name:"Engineering.fyi",
    ".":[ { title:"Tag",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/tag/:tag" ],
        target:"/engineering/tag/:tag" } ] },
  "englishhome.org":{ _name:"英語之家",
    ".":[ { title:"首頁",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/" ],
        target:"/englishhome/" } ] },
  ...
  "blogspot.com":{ _name:"歐洲動態（國際）",
    europechinese:[ { title:"最新",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/" ],
    ...
    ygkkk:[ { title:"最新发表",
        ...
        source:[ "/" ],
        target:"/ygkkk/" } ] },
  "eventbrite.com":{ _name:"Eventbrite",
    ".":[ { title:"Events",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/d/:region/:eventType" ],
        target:"/eventbrite/:region/:eventType" } ] },
  "eventbrite.ca":{ _name:"Eventbrite",
    ".":[ { title:"Events",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/d/:region/:eventType" ],
        target:"/eventbrite/:region/:eventType" } ] },
  "eventernote.com":{ _name:"Eventernote",
    www:[ { title:"声优活动及演唱会",
        docs:"https://docs.rsshub.app/routes/anime",
        source:[ "/actors/:name/:id",
          "/actors/:name/:id/events" ],
  ...
  "expats.cz":{ _name:"Expats.cz",
    www:[ { title:"Czech News",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/czech-news/:category" ],
        target:"/expatsparams=>{const category=params.category;return`/expats/czech-news${category?`/${category}`:\"\"}`}" },
      { title:"Daily News",
        docs:"https://docs.rsshub.app/routes/new-media",
  ...
  "fcbayern.com":{ _name:"FC Bayern München",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/sport",
        source:[ "/:language/news",
          "/:language" ],
        target:"/fcbayern/news/:language" } ] },
  "fcbayern.cn":{ _name:"FC Bayern München",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/sport",
        source:[ "/news",
          "/" ],
        target:"/fcbayern/news/zh" } ] },
  ...
  "fishshell.com":{ _name:"fish shell",
    ".":[ { title:"Unknown",
        ...
        source:[ "/" ],
        target:"/fishshell/" } ] },
  "fjdaily.com":{ _name:"福建日报",
    fjrb:[ { title:"电子报",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/pc/col/index.html" ],
        target:"/fjdaily/" },
      { title:"电子报",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/pc/col/:yearmonth/:day/node_:id.html" ],
        target:"/fjdaily/:date?" } ] },
  ...
  "futunn.com":{ _name:"Futubull 富途牛牛",
    news:[ { title:"快讯",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/main/live" ],
        target:"/futunn/live" },
      ...
      { title:"视频",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/main/video-list",
          "/:lang/main/video-list" ],
        target:"/futunn/video" },
      { title:"要闻",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/main",
  ...
  "gamekee.com":{ _name:"GameKee | 游戏百科攻略",
    ".":[ { title:"游戏情报",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/",
          "/news" ],
  ...
  "ganjingworld.com":{ _name:"Ganjing World",
  ...
  "gaoyu.me":{ _name:"Yu Gao",
    www:[ { title:"Blog",
        ...
        source:[ "/blog" ],
        target:"/gaoyu/blog" } ] },
  "pm.gc.ca":{ _name:"Prime Minister of Canada",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/",
          "/:language",
  ...
  "gcores.com":{ _name:"机核网",
    ...
    www:[ { title:"用户播客",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/users/:id/content",
          "/users/:id" ],
        target:"/gcores/users/:id/radios" },
      { title:"用户动态",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/users/:id/talks" ],
  ...
  "gitkraken.com":{ _name:"GitKraken",
    help:[ { title:"Release Notes",
        docs:"https://docs.rsshub.app/routes/program-update",
        source:[ "/gitkraken-desktop/current/" ],
        target:"/gitkraken/release-note" } ],
    www:[ { title:"Release Notes",
        docs:"https://docs.rsshub.app/routes/program-update",
        source:[ "/" ],
        target:"/gitkraken/release-note" } ] },
  ...
  "gitstar-ranking.com":{ _name:"Gitstar Ranking",
    ".":[ { title:"Ranking",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/:category" ],
  ...
  "globallawreview.org":{ _name:"环球法律评论",
    ".":[ { title:"Unknown",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/Magazine/GetIssueContentList",
          "/" ],
        target:"/globallawreview/" } ] },
  "gmcmonline.com":{ _name:"国门传媒在线",
    chinacustoms:[ { title:"中国海关",
        docs:"https://docs.rsshub.app/routes/reading",
        source:[ "/" ],
  ...
  "mhlw.go.jp":{ _name:"JapanGov",
    www:[ { title:"PDF",
      ...
      { title:"毎月勤労統計調査 全国調査（月別結果）",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/toukei/list/30-1a.html" ],
        target:"/mhlw/monthly-labour-survey" } ] },
  "gocn.vip":{ _name:"GoCN",
    ".":[ { title:"招聘",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/" ],
  ...
  "google.com":{ _name:"Google",
    ...
    play:[ { title:"Play Store Update",
        docs:"https://docs.rsshub.app/routes/program-update",
        source:[ "/store/apps/details?id=:id" ],
        target:"/google/play/:id/:lang?" } ] },
  "research.google":{ _name:"Google",
    ".":[ { title:"Research Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/" ],
        target:"/google/research" } ] },
  "caac.gov.cn":{ _name:"深圳市罗湖区人民政府",
    ".":[ { title:"公众留言",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/HDJL/" ],
        target:"/gov/caac/cjwt" } ] },
  "tqyb.com.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"广东省内城市预警信号",
        docs:"https://docs.rsshub.app/routes/forecast",
  ...
  "bjedu.gov.cn":{ _name:"深圳市罗湖区人民政府",
    gh:[ { title:"通用",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/ghsite/:urlPath/index.html",
          "/ghsite/:urlPath" ],
        target:"/gov/beijing/bjedu/gh/:urlPath" } ] },
  "beijing.gov.cn":{ _name:"深圳市罗湖区人民政府",
    jw:[ { title:"通知公告",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/tzgg" ],
        target:"/gov/beijing/jw/tzgg" } ] },
  "chinatax.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"最新文件",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/*" ],
        target:"/gov/chinatax/latest" } ] },
  "cq.gov.cn":{ _name:"深圳市罗湖区人民政府",
    rlsbj:[ { title:"重庆市人民政府 人力社保局 - 人事考试通知",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/" ],
  ...
  "cmse.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"飞行任务",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/fxrw" ],
        target:"/gov/cmse/fxrw" } ] },
  "csrc.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"政府信息公开",
        docs:"https://docs.rsshub.app/routes/government",
  ...
  "customs.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"拍卖信息 / 海关法规 / 最新文件",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/" ],
        target:"/gov/customs/list" } ] },
  "guizhou.gov.cn":{ _name:"深圳市罗湖区人民政府",
    jyt:[ { title:"贵州省教育厅 - 通知公告",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/zwgk/tzgg/",
          "/zwgk/tzgg/index.html" ],
        target:"/gov/guizhou/jyt/tzgg" } ] },
  "hangzhou.gov.cn":{ _name:"深圳市罗湖区人民政府",
    ".":[ { title:"政务服务公开",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/col/col1256349/index.html" ],
        target:"/gov/hangzhou/zwfw" } ] },
  "changsha.gov.cn":{ _name:"深圳市罗湖区人民政府",
    wlwz:[ { title:"长沙市人民政府",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/webapp/cs2020/email/*" ],
        target:"/gov/hunan/changsha/major-email" } ] },
  "jgjcndrc.org.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"中华人民共和国国家发展和改革委员会价格监测中心",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/list" ],
  ...
  "jiangsu.gov.cn":{ _name:"深圳市罗湖区人民政府",
    wlt:[ { title:"江苏文旅局审批公告",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/" ],
        target:"/gov/jiangsu/wlt" } ] },
  "jinan.gov.cn":{ _name:"深圳市罗湖区人民政府",
    jnmhc:[ { title:"获取国家医师资格考试通知",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/*" ],
        target:"/gov/jinan/healthcommission/medical_exam_notice" } ] },
  "lswz.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"国家粮食和物资储备局",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:category" ],
  ...
  "moa.gov.cn":{ _name:"深圳市罗湖区人民政府",
    "www.gjs":[ { title:"中华人民共和国农业农村部国际合作司",
        docs:"https://docs.rsshub.app/routes/government",
    ...
    www:[ { title:"中华人民共和国农业农村部生猪专题重要政策",
        docs:"https://docs.rsshub.app/routes/government",
  ...
  "moe.gov.cn":{ _name:"深圳市罗湖区人民政府",
    ".":[ { title:"司局通知",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/s78/:column/tongzhi",
          "/s78/:column" ],
        target:"/gov/moe/s78/:column" } ] },
  "mof.gov.cn":{ _name:"深圳市罗湖区人民政府",
    gss:[ { title:"关税政策文件",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/gzdt/:category/" ],
        target:"/gov/mof/gss/:category" } ] },
  "moj.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"立法意见征集",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/lfyjzj/lflfyjzj/*",
          "/pub/sfbgw/lfyjzj/lflfyjzj/*" ],
        target:"/gov/moj/lfyjzj" } ] },
  "mot.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"中华人民共和国交通运输部",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:category" ],
        target:"/govparams=>{const category=params.category;return`/mot${category?`/${category}`:\"\"}`}" },
      { title:"交通要闻",
        docs:"https://docs.rsshub.app/routes/government",
  ...
  "ndrc.gov.cn":{ _name:"深圳市罗湖区人民政府",
    ...
    zfxxgk:[ { title:"中华人民共和国国家发展和改革委员会政府信息公开",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/web/dirlist.jsp" ],
        target:"/gov/ndrc/zfxxgk" } ] },
  "nea.gov.cn":{ _name:"深圳市罗湖区人民政府",
    ".":[ { title:"司工作进展",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/sjzz/:bureau/index.htm" ],
        target:"/gov/nea/sjzz/:bureau" } ] },
  "npc.gov.cn":{ _name:"深圳市罗湖区人民政府",
    ".":[ { title:"通用",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/npc/c2/:caty" ],
        target:"/gov/npc/:caty" } ] },
  "pbc.gov.cn":{ _name:"深圳市罗湖区人民政府",
    ".":[ { title:"沟通交流",
        docs:"https://docs.rsshub.app/routes/finance",
      ...
      { title:"Unknown",
        ...
        target:"/gov/pbc/zcyj" } ] },
  "pudong.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"政务公开-浦东新区",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/zwgk/zxxxgk/index.html" ],
        target:"/gov/pudong/zwgk" } ] },
  "samr.gov.cn":{ _name:"深圳市罗湖区人民政府",
    xgzlyhd:[ { title:"留言咨询",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/gjjly/index" ],
        target:"/gov/samr/xgzlyhd/:category?/:department?" } ] },
  "sh.gov.cn":{ _name:"深圳市罗湖区人民政府",
    fgw:[ { title:"上海市发展和改革委员会",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:category" ],
  ...
  "szlh.gov.cn":{ _name:"深圳市罗湖区人民政府",
    ".":[ { title:"深圳市罗湖区人民政府",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/zwfw/zffw/:caty" ],
        target:"/gov/shenzhen/szlh/zwfw/zffw/:caty" } ] },
  "mztoday.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"今日绵竹",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/*" ],
        target:"/gov/sichuan/deyang/mztoday" } ] },
  "stats.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"国家统计局 通用",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/*path" ],
        target:"/gov/gov/stats/*path" } ] },
  "suzhou.gov.cn":{ _name:"深圳市罗湖区人民政府",
    www:[ { title:"政府信息公开文件",
        docs:"https://docs.rsshub.app/routes/government",
  ...
  "gq.com":{ _name:"GQ",
    ".":[ { title:"News",
        ...
        source:[ "/" ],
        target:"/gq/news" } ] },
  "grainoil.com.cn":{ _name:"国家粮油信息中心",
    load:[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category/:id" ],
  ...
  "hebtv.com":{ _name:"河北网络广播电视台",
    "web.cmc":[ { title:"农博士在行动",
        docs:"https://docs.rsshub.app/routes/traditional-media",
  ...
  "hicairo.com":{ _name:"HiFeng'Blog",
    ".":[ { title:"最近发表",
        ...
        source:[ "/" ],
        target:"/hicairo/" } ] },
  "hinatazaka46.com":{ _name:"Sakamichi Series 坂道系列官网资讯",
  ...
  "hket.com":{ _name:"香港经济日报",
    ...
    www:[ { title:"新闻",
        ...
        source:[ "/" ],
        target:"/hket/" } ] },
  "hkjunkcall.com":{ _name:"HKJunkCall 資訊中心",
    ".":[ { title:"Unknown",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/" ],
        target:"/hkjunkcall/" } ] },
  "weather.gov.hk":{ _name:"Hong Kong Observatory",
    www:[ { title:"Current Weather Report",
        ...
        target:"/hko/weather" } ] },
  "hkushop.com":{ _name:"環球唱片(香港)官方網上商店",
    ".":[ { title:"HKU Shop 黑胶专区",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/vinyl-or-picture-lp.html",
          "/" ],
        target:"/hkushop/vinyl" } ] },
  "hlju.edu.cn":{ _name:"黑龙江大学",
    hdxw:[ { title:"新闻网",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:category.htm",
          "/" ],
  ...
  "hudsonrivertrading.com":{ _name:"Hudson River Trading",
    www:[ { title:"Tech Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/hrtbeat/" ],
  ...
  "huggingface.co":{ _name:"Huggingface",
    ".":[ { title:"User Likes Activity",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/:user/activity/likes" ],
        target:"/huggingface/activity/:user/likes" },
  ...
  "huijin-inv.cn":{ _name:"中央汇金投资有限责任公司",
    www:[ { title:"资讯中心",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/" ],
        target:"/huijin-inv/news" } ] },
  "humanlayer.dev":{ _name:"HumanLayer",
    www:[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/blog" ],
        target:"/humanlayer/humanlayer/blog" } ] },
  "hunanpea.com":{ _name:"湖南人事考试网",
    rsks:[ { title:"公告",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/Category/:guid/ArticlesByCategory.do" ],
        target:"/hunanpea/rsks/:guid" } ] },
  "hunau.edu.cn":{ _name:"湖南农业大学",
    xky:[ { title:"公共管理与法学学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/",
          "/tzgg_8472",
    ...
    m:[ { title:"热帖",
      ...
      { title:"手机虎扑网",
        ...
        source:[ "/:category",
          "/" ],
        target:"/hupu/:category" } ] },
  "hust.edu.cn":{ _name:"华中科技大学",
    aia:[ { title:"人工智能和自动化学院新闻",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/xyxw.htm",
          "/" ],
  ...
  "hypergryph.com":{ _name:"鹰角网络",
    "ak-conf":[ { title:"明日方舟 - 游戏公告与新闻",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/news" ],
        target:"/hypergryph/arknights/news/:group?" } ],
    endfield:[ { title:"明日方舟：终末地 - 游戏公告与新闻",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/news" ],
        target:"/hypergryph/endfield/news/:group?" } ] },
  "i-cable.com":{ _name:"有線新聞",
    www:[ { title:"新聞",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/" ],
        target:"/i-cable/news" },
  ...
  "iapp.org":{ _name:"IAPP",
    ".":[ { title:"News",
        ...
        source:[ "/news" ],
        target:"/iapp/news" } ] },
  "icac.org.hk":{ _name:"Hong Kong Independent Commission Against Corruption 香港廉政公署",
    ".":[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:lang/press/index.html" ],
        target:"/icac/news/:lang" } ] },
  "icbc.com.cn":{ _name:"中国工商银行",
    ".":[ { title:"外汇牌价",
        docs:"https://docs.rsshub.app/routes/other",
  ...
  "idolmaster-official.jp":{ _name:"アイドルマスター THE IDOLM@STER",
    ".":[ { title:"ニュース News",
        docs:"https://docs.rsshub.app/routes/anime",
        source:[ "/news" ],
        target:"/idolmaster/news" } ] },
  "idolypride.jp":{ _name:"IDOLY PRIDE 偶像荣耀",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/anime",
        source:[ "/news" ],
  ...
  "neea.cn":{ _name:"IELTS 雅思",
    ...
    chengkao:[ { title:"成人高考动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/neea/local/chengkao" } ],
    yankao:[ { title:"研究生考试动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
    ...
    ntce:[ { title:"中小学教师资格考试动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/neea/local/ntce" } ],
    tdxl:[ { title:"同等学力申请硕士学位考试动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/neea/local/tdxl" } ],
    cet:[ { title:"全国四六级考试（CET）动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/neea/local/cet" } ],
    ncre:[ { title:"全国计算机等级考试（NCRE）动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/neea/local/ncre" } ],
    nit:[ { title:"全国计算机应用水平考试（NIT）动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/neea/local/nit" } ],
    pets:[ { title:"全国英语等级考试（PETS）动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/neea/local/pets" } ],
    wsk:[ { title:"全国外语水平考试（WSK）动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/neea/local/wsk" } ],
    ccpt:[ { title:"书画等级考试（CCPT）动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
  ...
  "imop.com":{ _name:"imop",
    t:[ { title:"全部消息",
        ...
        source:[ "/" ],
        target:"/imop/tianshu" } ] },
  "inceptionlabs.ai":{ _name:"Inception Labs",
    www:[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/blog" ],
        target:"/inceptionlabs/blog" } ] },
  "indianexpress.com":{ _name:"The Indian Express",
    ".":[ { title:"Section",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/section/:id" ],
  ...
  "indienova.com":{ _name:"indienova 独立游戏",
    ".":[ { title:"专题",
        docs:"https://docs.rsshub.app/routes/game",
  ...
  "iqnew.com":{ _name:"爱 Q 生活网",
    ".":[ { title:"最近更新",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/post/new_100/",
          "/" ],
        target:"/iqnew/latest" } ] },
  "iresearch.com.cn":{ _name:"艾瑞咨询",
    www:[ { title:"周度市场观察",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/report.shtml" ],
        target:"/iresearch(_,url)=>{const urlObj=new URL(url);const id=urlObj.searchParams.get(\"classId\")??urlObj.searchParams.get(\"channelId\")??urlObj.searchParams.get(\"cid\")??void 0;return`/iresearch/weekly${id?`/${id}`:\"\"}`}" },
      { title:"家电行业",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/report.shtml" ],
      ...
      { title:"研究报告",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/report.shtml" ],
        target:"/iresearch(_,url)=>{const urlObj=new URL(url);const type=urlObj.searchParams.get(\"type\")??void 0;const id=urlObj.searchParams.get(\"classId\")??urlObj.searchParams.get(\"channelId\")??urlObj.searchParams.get(\"cid\")??void 0;return`/iresearch/report${type?`/${type}${id?`/${id}`:\"\"}`:\"\"}`}" },
      { title:"最新报告",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/report.shtml" ],
        target:"/iresearch(_,url)=>{const urlObj=new URL(url);const id=urlObj.searchParams.get(\"classId\")??urlObj.searchParams.get(\"channelId\")??urlObj.searchParams.get(\"cid\")??void 0;return`/iresearch/report/1${id?`/${id}`:\"\"}`}" },
      { title:"研究图表",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/report.shtml" ],
        target:"/iresearch(_,url)=>{const urlObj=new URL(url);const id=urlObj.searchParams.get(\"classId\")??urlObj.searchParams.get(\"channelId\")??urlObj.searchParams.get(\"cid\")??void 0;return`/iresearch/report/4${id?`/${id}`:\"\"}`}" },
      { title:"周度市场观察",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/report.shtml" ],
        target:"/iresearch(_,url)=>{const urlObj=new URL(url);const id=urlObj.searchParams.get(\"classId\")??urlObj.searchParams.get(\"channelId\")??urlObj.searchParams.get(\"cid\")??void 0;return`/iresearch/report/3${id?`/${id}`:\"\"}`}" },
      { title:"热门报告",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/report.shtml" ],
        target:"/iresearch(_,url)=>{const urlObj=new URL(url);const id=urlObj.searchParams.get(\"classId\")??urlObj.searchParams.get(\"channelId\")??urlObj.searchParams.get(\"cid\")??void 0;return`/iresearch/report/2${id?`/${id}`:\"\"}`}" },
      { title:"周度市场观察 - 家电行业",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/report.shtml" ],
  ...
  "ithome.com":{ _name:"iThome 台灣",
    ".":[ { title:"标签",
      ...
      { title:"专题",
        ...
        source:[ "/zt/:id" ],
        target:"/ithome/zt/:id" } ] },
  "ithome.com.tw":{ _name:"iThome 台灣",
    www:[ { title:"Feeds",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category",
          "/:category/feeds" ],
        target:"/ithome/tw/feeds/:category" } ] },
  "itsec.gov.cn":{ _name:"中国信息安全测评中心",
    www:[ { title:"新闻发布",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/zxxw/index.html",
          "/zxxw/" ],
        target:"/itsec/news" } ] },
  "iwara.tv":{ _name:"iwara",
    www:[ { title:"Ranking",
        ...
        source:[ "/videos",
          "/images" ],
        target:"/iwara(params,url)=>{const searchParams=new URL(url).searchParams;const type=url.includes(\"/videos\")?\"video\":\"image\";const sort=searchParams.get(\"sort\")||\"date\";const rating=searchParams.get(\"rating\")||\"ecchi\";return`/iwara/ranking/${type}/${sort}/${rating}`}" },
      { title:"User Subscriptions",
        docs:"https://docs.rsshub.app/routes/anime",
        source:[ "/subscriptions/videos",
  ...
  "j-test.com":{ _name:"实用日本语鉴定考试（J.TEST）",
    www:[ { title:"公告",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/" ],
        target:"/j-test/news" } ] },
  "jable.tv":{ _name:"jable",
    ".":[ { title:"Jable 搜索结果",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/search/:query" ],
        target:"/jable/search/:query" } ] },
  ...
  "jbma.net":{ _name:"Japan Bullion Market Association",
  ...
  "okjike.com":{ _name:"即刻",
    ...
    m:[ { title:"圈子",
      ...
      { title:"圈子 - 纯文字",
        ...
        source:[ "/topics/:id" ],
        target:"/jike/topic/text/:id" } ] },
  "jimmyspa.com":{ _name:"幾米 JIMMY S.P.A. Official Website",
    www:[ { title:"Books",
        docs:"https://docs.rsshub.app/routes/design",
  ...
  "jiuyangongshe.com":{ _name:"韭研公社",
    www:[ { title:"社群",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/" ],
        target:"/jiuyangongshe/community" } ] },
  "jl1mall.com":{ _name:"吉林一号网",
    www:[ { title:"推荐",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/forum/" ],
  ...
  "jlu.edu.cn":{ _name:"吉林大学",
    ccst:[ { title:"吉林大学计算机科学与技术学院 - 新闻中心",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/xwzx/gsl.htm",
          "/xwzx/xstd.htm",
          "/xwzx/xytz.htm",
  ...
  "joins.com":{ _name:"中央日报",
    chinese:[ { title:"中央日报中文版",
        docs:"https://docs.rsshub.app/routes/traditional-media",
  ...
  "joneslanglasalle.com.cn":{ _name:"Jones Lang LaSalle",
    ".":[ { title:"Trends & Insights",
      ...
      { title:"Latest",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/en-cn/insights" ],
        target:"/joneslanglasalle/en/trends-and-insights" },
      { title:"房地产趋势与洞察",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/zh-cn/insights" ],
        target:"/joneslanglasalle/zh/trends-and-insights" } ] },
  "jll.com":{ _name:"Jones Lang LaSalle",
    ".":[ { title:"Trends & Insights",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/zh-hk/insights" ],
        target:"/joneslanglasalle/zh-hk/trends-and-insights" },
      { title:"Trends & Insights",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/en-hk/insights" ],
        target:"/joneslanglasalle/en-hk/trends-and-insights" } ] },
  ...
  "kbs.co.kr":{ _name:"KBS",
    world:[ { title:"News",
      ...
      { title:"Today",
        ...
        source:[ "/" ],
        target:"/kbs/today" } ] },
  "kcna.kp":{ _name:"Korean Central News Agency (KCNA) 朝鲜中央通讯社",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/:lang",
  ...
  "konachan.net":{ _name:"Konachan.com Anime Wallpapers",
    ".":[ { title:"Popular Recent Posts",
        docs:"https://docs.rsshub.app/routes/picture",
        source:[ "/post" ],
        target:"/konachan/post/popular_recent/:period?" },
  ...
  "koyso.to":{ _name:"Koyso",
    ".":[ { title:"游戏",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/" ],
        target:"/koyso(_,url)=>{const urlObj=new URL(url);const category=urlObj.searchParams.get(\"category\")??void 0;const sort=urlObj.searchParams.get(\"sort\")??void 0;return`/koyso${category?`/${category}`:\"0\"}${sort?`/${sort}`:\"\"}`}" },
      { title:"全部游戏",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/" ],
        target:"/koyso/0" },
  ...
  "kurogames.com":{ _name:"库洛游戏 | Kuro Games",
    mc:[ { title:"鸣潮 — 游戏公告、新闻与活动",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/m/main/news",
          "/main" ],
  ...
  "lala.im":{ _name:"荒岛",
    ".":[ { title:"最新发布",
        ...
        source:[ "/" ],
        target:"/lala/" } ] },
  "lancedb.com":{ _name:"LanceDB",
    ".":[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/blog",
          "/blog/category/:category" ],
        target:"/lancedb/blog/:category" } ] },
  "landiannews.com":{ _name:"蓝点网",
    www:[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:slug" ],
  ...
  "lephoceen.fr":{ _name:"Le Phocéen",
    ".":[ { title:"Fil Info Le Phocéen (Chrono)",
        docs:"https://docs.rsshub.app/routes/sport",
        source:[ "/chrono" ],
        target:"/lephoceen/chrono" } ] },
  "letterboxd.com":{ _name:"Letterboxd",
  ...
  "lhratings.com":{ _name:"联合资信评估股份有限公司",
    www:[ { title:"研究报告",
        docs:"https://docs.rsshub.app/routes/finance",
  ...
  "lmu.de":{ _name:"Ludwig Maximilian University of Munich",
    www:[ { title:"Job Openings",
        ...
        target:"/lmu/lmu/jobs" } ] },
  "locals.com":{ _name:"Locals",
    ".":[ { title:"Content Feed",
        docs:"https://docs.rsshub.app/routes/social-media",
        source:[ "/:community/feed" ],
        target:"/locals/content/:community" } ] },
  ...
  "maoyan.com":{ _name:"猫眼电影",
    piaofang:[ { title:"实时票房榜",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/dashboard" ],
        target:"/maoyan/box" } ],
    www:[ { title:"即将上映",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/films?showType=2",
          "/films" ],
  ...
  "sonatype.com":{ _name:"Maven",
    central:[ { title:"Maven Central Feed",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/artifact/:group/:artifact/:suffix",
  ...
  "mdpi.com":{ _name:"MDPI",
    www:[ { title:"Journal",
        ...
        source:[ "/journal/:journal" ],
        target:"/mdpi/:journal" } ] },
  "medieval-china.club":{ _name:"中国的中古",
    ".":[ { title:"Unknown",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/" ],
  ...
  "meituan.com":{ _name:"美团",
    tech:[ { title:"技术团队博客",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/" ],
        target:"/meituan/tech" } ] },
  "meritalk.com":{ _name:"MeriTalk",
    ".":[ { title:"Latest Articles",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/articles/" ],
        target:"/meritalk/articles" } ] },
  "meta.com":{ _name:"Meta",
    ai:[ { title:"AI Blog",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/blog/",
  ...
  "mirrormedia.mg":{ _name:"鏡週刊 Mirror Media",
    ".":[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/category/:category",
          "/section/:section" ],
  ...
  "mit.edu":{ _name:"Massachusetts Institute of Technology",
    scratch:[ { title:"Scratch User Projects",
        docs:"https://docs.rsshub.app/routes/social-media",
    ...
    hanlab:[ { title:"HAN Lab Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/blog" ],
        target:"/mit/hanlab/blog" } ] },
  "miui.com":{ _name:"MIUI",
    "web.vip":[ { title:"小米社区用户发帖",
        docs:"https://docs.rsshub.app/routes/bbs",
  ...
  "miyuki.jp":{ _name:"中島みゆき Official",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/",
          "/s/y10/news/list" ],
        target:"/miyuki/news" } ] },
  "modelscope.cn":{ _name:"ModelScope 魔搭社区",
    www:[ { title:"研习社",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/learn" ],
  ...
  "moodysmismicrosite.com":{ _name:"穆迪评级",
    www:[ { title:"industry",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/report" ],
  ...
  "my-formosa.com":{ _name:"美麗島電子報",
    ".":[ { title:"首页",
        ...
        source:[ "/" ],
        target:"/my-formosa/" } ] },
  "mycard520.com.tw":{ _name:"MyCard娛樂中心",
    app:[ { title:"遊戲新聞",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/category/:category" ],
  ...
  "nanhua.net":{ _name:"南华期货",
    mall:[ { title:"研报",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/mall/r/w/reportNew/report-list.html" ],
        target:"/nanhua(_,url)=>{const params=new URL(url).searchParams;const type1=params.get(\"type1\");const type2=params.get(\"type2\");return type1&&type2?`/nanhua/report/${encodeURIComponent(type1)}/${encodeURIComponent(type2)}`:\"\"}" } ] },
  "nankai.edu.cn":{ _name:"南开大学",
    ai:[ { title:"人工智能学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/",
          "/xwzx/:type.htm" ],
  ...
  "naturalism.org":{ _name:"Naturalism.org",
    ".":[ { title:"What's New",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/" ],
        target:"/naturalism/" } ] },
  ...
  "netflav.com":{ _name:"Netflav",
    ".":[ { title:"Unknown",
        ...
        source:[ "/" ],
        target:"/netflav/" } ] },
  "netflix.com":{ _name:"Netflix",
    about:[ { title:"Newsroom",
        docs:"https://docs.rsshub.app/routes/new-media",
  ...
  "newsmarket.com.tw":{ _name:"上下游 News&Market",
    ".":[ { title:"分類",
        docs:"https://docs.rsshub.app/routes/new-media",
  ...
  "nhk.or.jp":{ _name:"NHK",
    www3:[ { title:"WORLD-JAPAN - Top Stories",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/nhkworld/:lang/news/list/",
          "/nhkworld/:lang/news/" ],
        target:"/nhk/news/:lang" } ] },
  "web.nhk":{ _name:"NHK",
    news:[ { title:"News Web Easy",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/news/easy/",
          "/" ],
        target:"/nhk/news_web_easy" } ] },
  "niaogebiji.com":{ _name:"鸟哥笔记",
    ".":[ { title:"今日事",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/",
          "/bulletin" ],
  ...
  "nikkei.com":{ _name:"The Nikkei 日本経済新聞",
  ...
  "nmc.cn":{ _name:"中央气象台",
    www:[ { title:"产品",
        ...
        target:"/nmcparams=>{const path=params.path;const ext=params.ext;const id=path&&ext?`${path}/${ext}`:void 0;return`/nmc/publish${id?`/${id}`:\"\"}`}" },
      { title:"首页 - 卫星云图",
        docs:"https://docs.rsshub.app/routes/forecast",
      ...
      { title:"天气预报 - 全球灾害性天气监测月报",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/tianqiyubao/quanqiuzaihaixingtianqijianceyuebao/index.html" ],
        target:"/nmc/publish/tianqiyubao/quanqiuzaihaixingtianqijianceyuebao/index/html" },
      { title:"天气预报 - 环境气象公报",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/observations/environmental.html" ],
        target:"/nmc/publish/observations/environmental/html" },
      ...
      { title:"全球预报 - 全球热带气旋监测公报",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/quanqiuyubao/quanqiuredaiqixuanjiancegongbao/index.html" ],
        target:"/nmc/publish/quanqiuyubao/quanqiuredaiqixuanjiancegongbao/index/html" },
      { title:"全球预报 - WMO第XI海区海事天气公报",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/quanqiuyubao/WMOdiXIhaiquhaishitianqigongbao/index.html" ],
        target:"/nmc/publish/quanqiuyubao/WMOdiXIhaiquhaishitianqigongbao/index/html" },
      { title:"全球预报 - 全球灾害性天气监测月报",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/quanqiuyubao/quanqiuzaihaixingtianqijianceyuebao/index.html" ],
        target:"/nmc/publish/quanqiuyubao/quanqiuzaihaixingtianqijianceyuebao/index/html" },
      { title:"全球预报 - 全球雨雪落区预报",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/quanqiuyubao/quanqiuyuxueluoquyubao/yazhou/24xiaoshi/index.html" ],
        target:"/nmc/publish/quanqiuyubao/quanqiuyuxueluoquyubao/yazhou/24xiaoshi/index/html" },
      { title:"环境气象 - 雾预报",
        docs:"https://docs.rsshub.app/routes/forecast",
      ...
      { title:"环境气象 - 大气环境气象公报",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/environment/National-Bulletin-atmospheric-environment.htm" ],
        target:"/nmc/publish/environment/National-Bulletin-atmospheric-environment/htm" },
      { title:"农业气象 - 土壤水分监测",
        docs:"https://docs.rsshub.app/routes/forecast",
      ...
      { title:"农业气象 - 农业干旱综合监测",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/agro/disastersmonitoring/Agricultural_Drought_Monitoring.htm" ],
        target:"/nmc/publish/agro/disastersmonitoring/Agricultural_Drought_Monitoring/htm" },
      { title:"农业气象 - 关键农时农事",
        docs:"https://docs.rsshub.app/routes/forecast",
      ...
      { title:"农业气象 - 生态气象监测评估",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/nongyeqixiang/shengtaiqixiangjiance/caodishengtaiqixiangjiance/index.html" ],
        target:"/nmc/publish/nongyeqixiang/shengtaiqixiangjiance/caodishengtaiqixiangjiance/index/html" },
      { title:"农业气象 - 农业气象专报",
        docs:"https://docs.rsshub.app/routes/forecast",
      ...
      { title:"农业气象 - 农业气象灾害风险预警",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/nongyeqixiang/quanguonongyeqixiangzaihaifengxianyujing/index.html" ],
        target:"/nmc/publish/nongyeqixiang/quanguonongyeqixiangzaihaifengxianyujing/index/html" },
      { title:"农业气象 - 国外农业气象月报",
        docs:"https://docs.rsshub.app/routes/forecast",
        source:[ "/publish/nongyeqixiang/guowainongyeqixiangyuebao/index.html" ],
        target:"/nmc/publish/nongyeqixiang/guowainongyeqixiangyuebao/index/html" } ],
    ".":[ { title:"全国气象预警",
        docs:"https://docs.rsshub.app/routes/forecast",
  ...
  "nogizaka46.com":{ _name:"Sakamichi Series 坂道系列官网资讯",
    blog:[ { title:"Nogizaka46 Blog 乃木坂 46 博客",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/s/n46/diary/MEMBER" ],
        target:"/nogizaka46/blog" } ],
    news:[ { title:"Nogizaka46 News 乃木坂 46 新闻",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/s/n46/news/list" ],
        target:"/nogizaka46/news" } ] },
  "nosec.org":{ _name:"NOSEC 安全讯息平台",
    ".":[ { title:"Posts",
        docs:"https://docs.rsshub.app/routes/programming",
  ...
  "ntrblog.com":{ _name:"NTR BLOG（寝取られブログ）",
    ".":[ { title:"Articles",
        docs:"https://docs.rsshub.app/routes/anime",
        source:[ "/" ],
        target:"/ntrblog/articles" } ] },
  "nua.edu.cn":{ _name:"Nanjing University of the Arts 南京艺术学院",
    ...
    sxw:[ { title:"Shuangxing Information",
        ...
        source:[ "/:type/list.htm" ],
        target:"/nua/sxw/:type" } ] },
  "nudt.edu.cn":{ _name:"中国人民解放军国防科技大学",
    yjszs:[ { title:"研究生院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
  ...
  "nuist.edu.cn":{ _name:"南京信息工程大学",
    bulletin:[ { title:"南信大信息公告栏",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:filename" ],
        target:"/nuistparams=>{const filename=params.filename.replace(/\\.htm$/i,\"\");return`/nuist${filename===\"index\"?\"/bulletin\":`/bulletin/${filename}`}`}" } ],
    lib:[ { title:"Unknown",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/",
          "/index/tzgg.htm" ],
        target:"/nuist/lib" } ],
    scs:[ { title:"NUIST CS（南信大计软院）",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:category/list.htm" ],
    ...
    xgc:[ { title:"南信大学生工作处",
        ...
        source:[ "/",
          "/419/list.htm" ],
        target:"/nuist/xgc" } ] },
  "nwnu.edu.cn":{ _name:"西北师范大学",
    jsj:[ { title:"计算机科学与工程学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:column/list" ],
  ...
  "nyc.gov":{ _name:"New York City Government",
  ...
  "okx.com":{ _name:"欧易 OKX",
    www:[ { title:"公告",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/zh-hans/help/section/:section" ],
        target:"/okx/:section" } ] },
  "olevod.one":{ _name:"欧乐影院",
    www:[ { title:"视频",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/vod/:id" ],
  ...
  "ornl.gov":{ _name:"Oak Ridge National Laboratory",
    www:[ { title:"All News",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/all-news" ],
  ...
  "oshwhub.com":{ _name:"oshwhub 立创开源硬件平台",
    ".":[ { title:"开源广场",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/explore" ],
  ...
  "pacilution.com":{ _name:"普世社会科学研究所",
    www:[ { title:"最新文章",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/" ],
  ...
  "perplexity.ai":{ _name:"Perplexity",
    www:[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/hub" ],
        target:"/perplexity/blog" },
      { title:"Changelog",
        docs:"https://docs.rsshub.app/routes/program-update",
        source:[ "/changelog" ],
        target:"/perplexity/changelog" } ] },
  "peterwunder.de":{ _name:"Peter Wunder",
    projects:[ { title:"New Badges",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/achievements" ],
        target:"/peterwunder/achievements" } ] },
  "phoronix.com":{ _name:"Phoronix",
    ".":[ { title:"News & Reviews",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category?/:topic?" ],
        target:"/phoronix/:category?/:topic?" } ] },
  "pianyivps.com":{ _name:"便宜VPS网",
    ".":[ { title:"最新发布",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/" ],
        target:"/pianyivps/" } ] },
  ...
  "pixelstech.net":{ _name:"PixelsTech",
    www:[ { title:"Feed",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/feed/:topic" ],
  ...
  "pku.edu.cn":{ _name:"北京大学",
    ...
    nsd:[ { title:"观点 - 国家发展研究院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/pku/nsd/gd" } ],
    admission:[ { title:"研究生招生网",
        docs:"https://docs.rsshub.app/routes/university",
  ...
  "playno1.com":{ _name:"PLAYNO.1 玩樂達人",
    stno1:[ { title:"情趣",
        docs:"https://docs.rsshub.app/routes/bbs",
        source:[ "/stno1/:catid/" ],
  ...
  "polymarket.com":{ _name:"Polymarket",
    ".":[ { title:"Event",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/event/:slug" ],
        target:"/polymarket/event/:slug" },
      { title:"Events",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/",
          "/:tagSlug" ],
        target:"/polymarket/events/:tagSlug" },
      { title:"Series",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/series/:slug" ],
        target:"/polymarket/series/:slug" } ] },
  ...
  "priconne-redive.jp":{ _name:"PRINCESS CONNECT! Re Dive プリンセスコネクト！Re Dive",
    ".":[ { title:"最新公告",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/news" ],
        target:"/priconne-redive/news/jp" } ] },
  "so-net.tw":{ _name:"PRINCESS CONNECT! Re Dive プリンセスコネクト！Re Dive",
    princessconnect:[ { title:"最新公告",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/news" ],
        target:"/priconne-redive/news/zh-tw" } ] },
  "producereport.com":{ _name:"Produce Report",
    www:[ { title:"Category",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category" ],
  ...
  "qq.com":{ _name:"腾讯网",
    ...
    "cfhd.cf":[ { title:"穿越火线 CFHD 专区资讯中心 - 最新",
        docs:"https://docs.rsshub.app/routes/game",
    ...
    news:[ { title:"用户主页列表",
        docs:"https://docs.rsshub.app/routes/social-media",
        source:[ "/omn/author/:uid" ],
        target:"/qq/qq/news/:uid" },
      { title:"当前作者文章",
        docs:"https://docs.rsshub.app/routes/new-media",
  ...
  "quantamagazine.org":{ _name:"Quanta Magazine",
    ".":[ { title:"Archive",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/" ],
  ...
  "qust.edu.cn":{ _name:"青岛科技大学",
    jw:[ { title:"教务通知",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/jwtz.htm",
          "/" ],
        target:"/qust/jw" } ] },
  "qztc.edu.cn":{ _name:"泉州师范学院",
    www:[ { title:"首页",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:type/list.htm" ],
  ...
  "readsomethingwonderful.com":{ _name:"Read Something Wonderful",
    ".":[ { title:"Articles",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/" ],
  ...
  "rfi.fr":{ _name:"Radio France Internationale",
    ".":[ { title:"Generic News",
        ...
        source:[ "/*path" ],
        target:"/rfi/:path" } ] },
  "rockthejvm.com":{ _name:"Rock the JVM",
    ".":[ { title:"Article",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/articles" ],
        target:"/rockthejvm/articles" } ] },
  "rodong.rep.kp":{ _name:"Rodong Sinmun 劳动新闻",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/cn/index.php",
          "/en/index.php",
  ...
  "rule34video.com":{ _name:"Rule34Video",
    ".":[ { title:"Latest Updates",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/latest-updates/" ],
        target:"/rule34video/latest" } ] },
  "runyeah.world":{ _name:"跑野大爆炸",
    ".":[ { title:"最新文章",
        docs:"https://docs.rsshub.app/routes/sport",
        source:[ "/" ],
        target:"/runyeah/" } ] },
  "rustcc.cn":{ _name:"Rust 语言中文社区",
    ".":[ { title:"招聘",
      ...
      { title:"新闻/聚合",
        ...
        source:[ "/" ],
        target:"/rustcc/news" } ] },
  "sakurazaka46.com":{ _name:"Sakamichi Series 坂道系列官网资讯",
    ".":[ { title:"Sakurazaka46 News 櫻坂 46 新闻",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/s/s46/news/list",
          "/" ],
        target:"/sakurazaka46/news" } ] },
  "samrdprc.org.cn":{ _name:"国家市场监督管理总局缺陷产品管理中心",
    www:[ { title:"栏目",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/:id" ],
        target:"/samrdprc/:id" },
  ...
  "sankei.com":{ _name:"Sankei Shimbun 産経新聞",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/:category" ],
  ...
  "nat.gov.tw":{ _name:"科技大觀園",
    scitechvista:[ { title:"最新文章",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/" ],
        target:"/scitechvista/" } ] },
  ...
  "scpta.com.cn":{ _name:"四川省人力资源和社会保障厅人事考试专栏",
    www:[ { title:"通知公告",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/front/News/List" ],
        target:"/scpta/news" } ] },
  "scu.edu.cn":{ _name:"四川大学",
    jwc:[ { title:"教务处通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/scu/jwc" } ] },
  "scut.edu.cn":{ _name:"华南理工大学",
    www2:[ { title:"电子与信息学院 - 新闻速递",
        docs:"https://docs.rsshub.app/routes/university",
  ...
  "secretsanfrancisco.com":{ _name:"Secret San francisco",
    ".":[ { title:"Category",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/:category" ],
  ...
  "sega.jp":{ _name:"SEGA",
    ...
    pjsekai:[ { title:"世界计划 多彩舞台 ｜ ProjectSekai ｜ プロセカ",
        docs:"https://docs.rsshub.app/routes/game",
  ...
  "semiconductors.org":{ _name:"Semiconductor Industry Association",
  ...
  "setn.com":{ _name:"三立新聞網",
    ".":[ { title:"新聞",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/ViewAll.aspx",
          "/" ],
        target:"/setn/:category?" } ] },
  "seu.edu.cn":{ _name:"东南大学",
    cse:[ { title:"计算机技术与工程学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:type/list.htm",
          "/" ],
        target:"/seu/cse/:type?" } ],
    cyber:[ { title:"网络空间安全学院 - 通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/tzgg/list.htm",
          "/" ],
        target:"/seu/cyber/tzgg" } ],
    radio:[ { title:"信息科学与工程学院学术活动",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/_s29/15986/list.psp",
          "/" ],
        target:"/seu/radio/academic" } ],
    seugs:[ { title:"研究生院全部公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/26671/list.htm",
          "/" ],
        target:"/seu/yjs" } ],
    yzb:[ { title:"研究生招生网通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:type/list.htm" ],
        target:"/seu/yzb/:type" } ] },
  "sfacg.com":{ _name:"SF 轻小说",
    book:[ { title:"章节",
        docs:"https://docs.rsshub.app/routes/reading",
        source:[ "/Novel/:id/*" ],
  ...
  "shanghaimuseum.net":{ _name:"Shanghai Museum",
    www:[ { title:"News & Announcements",
        ...
        target:"/shanghaimuseum/information/news" },
      { title:"Special Exhibitions",
        docs:"https://docs.rsshub.app/routes/travel",
        source:[ "/mu/frontend/pg/display/offline-exhibit" ],
        target:"/shanghaimuseum/display/offline-exhibit" } ] },
  "shanximuseum.com.cn":{ _name:"Shanxi Museum",
    www:[ { title:"Temporary Exhibitions",
        docs:"https://docs.rsshub.app/routes/travel",
        source:[ "/sx/exhibition/temporary.html" ],
        target:"/shanximuseum/exhibition/temporary" } ] },
  ...
  "shiep.edu.cn":{ _name:"上海电力大学",
    ...
    "energy-saving":[ { title:"上海热交换系统节能工程技术研究中心",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
    ...
    "green-energy":[ { title:"上海绿色能源并网技术研究中心",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
        target:"/shiep/green-energy/:id" } ],
    hhsyzx:[ { title:"能源化学实验教学中心",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
    ...
    hqglc:[ { title:"后勤管理处（后勤服务中心）",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
        target:"/shiep/hqglc/:id" } ],
    ieetc:[ { title:"创新创业工程训练中心",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
    ...
    jjc:[ { title:"基建处",
        ...
        source:[ "/:id/list.htm" ],
        target:"/shiep/jjc/:id" } ],
    jjxy:[ { title:"继续教育学院（国际教育学院）",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
        target:"/shiep/jjxy/:id" } ],
    jsjxfzzx:[ { title:"教师教学发展中心",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
    ...
    metc:[ { title:"现代教育技术中心/信息办",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
        target:"/shiep/metc/:id" } ],
    mpep:[ { title:"上海市电力材料防护与新材料重点实验室",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
    ...
    office:[ { title:"校长办公室（档案馆）",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
        target:"/shiep/office/:id" } ],
    rpstec:[ { title:"国家新能源电力系统实验教学示范中心",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
    ...
    spgc:[ { title:"智能发电实验教学中心",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
        target:"/shiep/spgc/:id" } ],
    sysyzcglc:[ { title:"实验室与资产管理处",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
    ...
    zzb:[ { title:"组织部（老干部处、党校）",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:id/list.htm" ],
        target:"/shiep/zzb/:id" } ] },
  "shisu.edu.cn":{ _name:"上海外国语大学",
  ...
  "sigsac.org":{ _name:"ACM Special Interest Group on Security Audit and Control",
    ".":[ { title:"The ACM Conference on Computer and Communications Security",
        ...
        source:[ "/ccs.html",
          "/" ],
        target:"/sigsac/ccs" } ] },
  "simpleinfo.cc":{ _name:"簡訊設計",
    blog:[ { title:"志祺七七",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/blog/:category" ],
        target:"/simpleinfo/:category" } ] },
  "sina.com.cn":{ _name:"新浪",
    tech:[ { title:"专栏 - 创事记",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/chuangshiji",
          "/" ],
  ...
  "snnu.edu.cn":{ _name:"Shaanxi Normal University",
    ccs:[ { title:"计算机科学学院",
        docs:"https://docs.rsshub.app/routes/university",
  ...
  "stbu.edu.cn":{ _name:"四川工商学院",
    jsjxy:[ { title:"计算机学院 - 通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/news",
          "/" ],
        target:"/stbu/jsjxy" } ],
  ...
  "straitstimes.com":{ _name:"The Strait Times",
    www:[ { title:"News",
      ...
      { title:"News",
        ...
        source:[ "/" ],
        target:"/straitstimes/" } ] },
  "stream-capital.com":{ _name:"远川研究所",
    www:[ { title:"最新",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/search" ],
  ...
  "sustech.edu.cn":{ _name:"南方科技大学",
    gs:[ { title:"研究生网通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/sustech/yjs" } ],
    biddingoffice:[ { title:"采购与招标管理部",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/sustech/bidding" } ],
    newshub:[ { title:"新闻网（中文）",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/news" ],
  ...
  "sysu.edu.cn":{ _name:"中山大学",
    cse:[ { title:"数据科学与计算机学院动态",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/sysu/cse" } ],
    ygafz:[ { title:"粤港澳发展研究院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:type" ],
  ...
  "tctmd.com":{ _name:"TCTMD",
    www:[ { title:"Conference News",
        docs:"https://docs.rsshub.app/routes/journal",
  ...
  "techflowpost.com":{ _name:"深潮 TechFlow",
    ".":[ { title:"快讯",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/zh-CN/newsletter" ],
        target:"/techflowpost/express" },
      { title:"精选",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/zh-CN/article" ],
  ...
  "tesla.cn":{ _name:"特斯拉中国",
    ".":[ { title:"价格",
        ...
        source:[ "/model3/design",
          "/" ],
        target:"/tesla/price" } ] },
  "tgbus.com":{ _name:"电玩巴士 TGBUS",
    www:[ { title:"文章列表",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/list/:category/" ],
        target:"/tgbus/list/:category" } ] },
  "river.to":{ _name:"River.to (江河日下)",
    ".":[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/:category" ],
        target:"/theparams=>{const category=params.category;return`/the${category?`/category/${category}`:\"\"}`}" },
      { title:"时局",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawj7o4ypewv94" ],
        target:"/the/the/category/rawj7o4ypewv94" },
      { title:"剩余价值",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawmw7dsta2jew" ],
        target:"/the/the/category/rawmw7dsta2jew" },
      { title:"Beijing",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawbcvxkktdkq8" ],
        target:"/the/the/category/rawbcvxkktdkq8" },
      { title:"稳中向好",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/raw4krvx85dh27" ],
        target:"/the/the/category/raw4krvx85dh27" },
      { title:"水深火热",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawtn8jpsc6uvv" ],
        target:"/the/the/category/rawtn8jpsc6uvv" },
      { title:"东升西降",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawai5kd4z15il" ],
        target:"/the/the/category/rawai5kd4z15il" },
      { title:"大局",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/raw2efkzejrsx8" ],
        target:"/the/the/category/raw2efkzejrsx8" },
      { title:"境外势力",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawmpalhnlphuc" ],
        target:"/the/the/category/rawmpalhnlphuc" },
      { title:"副刊",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawxght2jr2u5z" ],
        target:"/the/the/category/rawxght2jr2u5z" },
      { title:"天高地厚",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawrsnh9zakqdx" ],
        target:"/the/the/category/rawrsnh9zakqdx" },
      { title:"Oyster",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/occasus/rawdhl9hugdfn9" ],
        target:"/the/the/category/rawdhl9hugdfn9" } ] },
  ...
  "theblockbeats.info":{ _name:"律动 BlockBeats",
    www:[ { title:"文章",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/article" ],
  ...
  "thebrain.com":{ _name:"TheBrain",
    www:[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/blog" ],
        target:"/thebrain/blog" } ] },
  "thegadgetflow.com":{ _name:"Gadget Flow",
    ".":[ { title:"Category",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/categories/:category" ],
  ...
  "theinitium.com":{ _name:"The Initium",
    ".":[ { title:"App",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/latest/" ],
        target:"/theinitium/app/latest_sc" },
      { title:"作者",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/author/:type" ],
      ...
      { title:"栏目",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/latest/" ],
        target:"/theinitium/channel/latest" },
      { title:"栏目",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/tag/:type" ],
  ...
  "thepetcity.co":{ _name:"PetCity 毛孩日常",
  ...
  "theverge.com":{ _name:"The Verge",
    ".":[ { title:"Category",
        ...
        source:[ "/:hub",
          "/" ],
        target:"/theverge/:hub?" } ] },
  "thewirehindi.com":{ _name:"The Wire Hindi",
    ".":[ { title:"Category",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/category/*" ],
      ...
      { title:"Latest News",
        ...
        source:[ "/" ],
        target:"/thewirehindi/" } ] },
  "thinkingmachines.ai":{ _name:"Thinking Machines Lab",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/news",
          "/news/" ],
        target:"/thinkingmachines/news" } ] },
  ...
  "tidb.net":{ _name:"TiDB 社区",
    ".":[ { title:"专栏分类",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/blog",
          "/blog/c/:category" ],
        target:"/tidbparams=>{const category=params.category;return`/tidb/blog/c${category?`/${category}`:\"\"}`}" },
      { title:"全部文章",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/blog" ],
  ...
  "trendforce.com":{ _name:"TrendForce",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/news/" ],
        target:"/trendforce/news" } ] },
  "trendforce.cn":{ _name:"TrendForce",
    www:[ { title:"产业洞察",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/presscenter/news" ],
        target:"/trendforce/cn/presscenter/news" } ] },
  ...
  "tsinghua.edu.cn":{ _name:"清华大学",
    ...
    www:[ { title:"清华新闻",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/news/:category" ],
        target:"/tsinghua(_,url)=>`/tsinghua/news/${new URL(url).pathname.split(\"/\").pop()?.replace(\".htm\",\"\")}`" } ] },
  "ttv.com.tw":{ _name:"台視新聞網",
    news:[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/:category" ],
        target:"/ttv/:category?" } ] },
  ...
  "tw-nongmu.com":{ _name:"通威农业发展",
    www:[ { title:"鱼价行情",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/market.html",
          "/" ],
        target:"/tw-nongmu/market" } ] },
  ...
  "txks.org.cn":{ _name:"全国通信专业技术人员职业水平考试",
    www:[ { title:"全国通信专业技术人员职业水平考试动态",
        docs:"https://docs.rsshub.app/routes/study",
        source:[ "/index/work",
          "/" ],
        target:"/txks/news" } ] },
  "tynu.edu.cn":{ _name:"太原师范学院",
    ".":[ { title:"Unknown",
        ...
        source:[ "/index/tzgg.htm",
          ...
          "/" ],
        target:"/tynu/" } ] },
  "typeless.com":{ _name:"Typeless",
    www:[ { title:"Changelog",
        docs:"https://docs.rsshub.app/routes/program-update",
        source:[ "/help/release-notes/*",
          "/help/release-notes",
          "/" ],
  ...
  "uestc.edu.cn":{ _name:"电子科技大学",
    ...
    news:[ { title:"新闻中心",
        ...
        source:[ "/" ],
        target:"/uestc/news" } ],
    scse:[ { title:"计算机科学与工程学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/uestc/scse" } ],
    sice:[ { title:"信息与通信工程学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/uestc/sice" } ],
    sise:[ { title:"信息与软件工程学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/uestc/sise" } ] },
    ...
    m:[ { title:"绿洲用户",
      ...
      { title:"博主",
        ...
        source:[ "/u/:uid",
          "/profile/:uid" ],
        target:"/weibo/user/:uid" } ] },
  "wellcee.com":{ _name:"Wellcee 唯心所寓",
    www:[ { title:"支持的城市",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/" ],
  ...
  "who.int":{ _name:"World Health Organization | WHO",
    ".":[ { title:"News",
      ...
      { title:"Speeches",
        ...
        target:"/who/speeches" } ] },
  "whu.edu.cn":{ _name:"武汉大学",
    gs:[ { title:"研究生院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/index.htm",
          "/" ],
        target:"/whu/gs" } ],
    rsgis:[ { title:"武汉大学遥感信息工程学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/index.htm" ],
  ...
  "wikipedia.org":{ _name:"Wikipedia",
    en:[ { title:"Current Events",
        docs:"https://docs.rsshub.app/routes/new-media",
  ...
  "wkjyqh.com":{ _name:"五矿期货",
    www:[ { title:"研究报告",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/main/research_center/yjbg/index.shtml",
          "/main/research_center/" ],
        target:"/wkjyqh/research" } ] },
  "wnacg.com":{ _name:"紳士漫畫",
    ".":[ { title:"分类更新",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/*" ],
  ...
  "x-mol.com":{ _name:"X-MOL",
    ".":[ { title:"News",
        ...
        source:[ "/news/index" ],
        target:"/x-mol/news" } ] },
  "xboxfan.com":{ _name:"盒心光环",
    ".":[ { title:"资讯",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/" ],
        target:"/xboxfan/news" } ] },
  "xhamster.com":{ _name:"xHamster",
    ".":[ { title:"Newest Videos by Creator",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/creators/:creators",
          "/creators/:creators/newest" ],
        target:"/xhamster/:creators" } ] },
  "xianbao.fun":{ _name:"线报酷",
    "new":[ { title:"线板酷",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/" ],
        target:"/xianbao/" } ] },
  ...
  "xidian.edu.cn":{ _name:"西安电子科技大学",
    ...
    gr:[ { title:"研究生院/卓越工程师学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
        target:"/xidian/gr/:category?" } ] },
  "xjtlu.edu.cn":{ _name:"Xi'an Jiaotong-Liverpool University",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:lang/about/news/all-news",
          "/:lang/news" ],
  ...
  "xupt.edu.cn":{ _name:"西安邮电大学",
    jyc:[ { title:"教务处通知公告",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/index/tzgg.htm" ],
        target:"/xupt/jyc/tzgg" } ] },
  "xwenming.com":{ _name:"未知文明",
    www:[ { title:"分类",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/",
          "/index.php/category/:category" ],
  ...
  "zhizhuan100.com.cn":{ _name:"智篆商业",
    www:[ { title:"analytic",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/analysis" ],
        target:"/zhizhuan100/analytic" } ] },
  "zhonglun.com":{ _name:"中伦律师事务所",
    ".":[ { title:"专业文章",
        docs:"https://docs.rsshub.app/routes/new-media",
  ...
  "zhubai.love":{ _name:"竹白",
    analy:[ { title:"上周热门 TOP 20",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/" ],
        target:"/zhubai/top20" } ] },
  "zhujiceping.com":{ _name:"国外主机测评",
    ".":[ { title:"最新发布",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/" ],
        target:"/zhujiceping/" } ] },
  "zhuwang.cc":{ _name:"中国养猪网",
    zhujia:[ { title:"全国今日生猪价格",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/" ],
  ...
  "zjut.edu.cn":{ _name:"浙江工业大学",
    cs:[ { title:"浙江工业大学计算机科学与技术学院、软件学院",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/jsp/newsclass.jsp" ],
        target:"/zjut/cs/:type" } ],
    "www.jwc":[ { title:"浙江工业大学教务处",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:type/list.htm" ],
        target:"/zjut/jwc/:type" } ],
    "www.news":[ { title:"浙工大新闻",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/:type/list.htm" ],
  ...
  "zzu.edu.cn":{ _name:"郑州大学",
    "dwzzb.v":[ { title:"郑大党委组织部",
        docs:"https://docs.rsshub.app/routes/university",
        source:[ "/" ],
  ...
  "cline.bot":{ _name:"cline",
    ".":[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/blog",
        source:[ "/blog/archive",
          "/blog" ],
        target:"/cline/blog" } ] },
  "cognition.ai":{ _name:"cognition",
    ".":[ { title:"Blog",
        docs:"https://docs.rsshub.app/routes/programming",
        source:[ "/blog/1",
          "/blog/:category/1" ],
        target:"/cognition/blog/:category?" } ] },
  "x410.dev":{ _name:"x410",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/" ],
